...
namespace SharpHoning
{
    class HSHoningBayes
    {
        ...
        public void GenerateComboVector(ref List<String> combo, ref Dictionary<String, double[]> cardVec, out double[] HearthStoneBayesVector)
        {
        ...
        public void CalculateSurprise(ref List<String> combo, int N, out double[] surpriseVector, ref Dictionary<String, double[]> cardVec, out double surpriseMean, bool updateBayes)
        {
            double[] comboVector;
        ...
        private void CalculateStatistics()
        {
            ...
            for (int i = 0; i < sumVector.Length; i++)
                varianceVector[i] /= (bayesMatrix.Count);
