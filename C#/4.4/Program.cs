...
namespace SharpHoning
{
    ...
    public class Program
    {
        ...
        void ValidationTests(String cardsJson, String combosFile, int k)
        {
            ...
            //for (double threshold = 0.0; threshold <= 1.6; threshold += 0.1)
           // {
             //   for (int i = 1; i < 4; i++)
            //    {
                    String currentDirectory = "viableFrom_"+1+" threshold_" + 0;
                    ...
                    System.IO.StreamWriter meanFitness = new System.IO.StreamWriter(currentDirectory + "//fit.txt");
                    System.IO.StreamWriter meanEfficiency = new System.IO.StreamWriter(currentDirectory + "//eff.txt");
                    System.IO.StreamWriter meanSurprise = new System.IO.StreamWriter(currentDirectory + "//sur.txt");
                    System.IO.StreamWriter meanCreativity = new System.IO.StreamWriter(currentDirectory + "//crea.txt");

                    meanFitness.WriteLine("Hero Algorithm Value");
                    meanEfficiency.WriteLine("Hero Algorithm Value");
                    meanSurprise.WriteLine("Hero Algorithm Value");
                    meanCreativity.WriteLine("Hero Algorithm Value");
                    ...
                    foreach (String hero in parser.objects.Keys)
                    {
                        ...
                        recalibration(op, hero, 0, 1, meanFitness, meanEfficiency, meanSurprise, meanCreativity);
                    }

                    meanFitness.Close();
                    meanEfficiency.Close();
                    meanSurprise.Close();
                    meanCreativity.Close();
          //      }
           // }
                ...
                /* List<String> honingCombo;
                 ...
                 System.IO.StreamWriter calibration = new System.IO.StreamWriter(hero + "_calibration.cal");
                 ...
                 foreach (String c in Terminals)
                 {
                     for (int i = 0; i < 10; i++)
                     {
                         ...
                         randomComboList.Add(c.ToLower());
                         int manaCost = 0;
                         Int32.TryParse(cardTable[c.ToLower()].cost, out manaCost);
                         totalMana += manaCost;
                         ...
                         honingCombo = op.GenerateCardClusterNewRandom(
                                  c,
                                  ref cardTable,
                                  ref net,
                     ...
                     int percet = current / Terminals.Count;
                     Console.Write("=");
                 }

                 Console.WriteLine();
                 Console.WriteLine("Highest surprise: " + highSurp + "\nLowest surprise: " + minSurp + "\nHighest efficiency: " + highEff + "\nLowest efficiency: " + minEff);
                 Console.WriteLine("-                       Surprise calibrated!                         -");

                 calibration.WriteLine("Highest surprise: " + highSurp + "\nLowest surprise: " + minSurp + "\nHighest efficiency: " + highEff + "\nLowest efficiency: " + minEff);
                 calibration.Close();
                 */
                ...
                /* int seedCount = 1;
                 ...
                 // To write results
                 System.IO.StreamWriter I = new System.IO.StreamWriter(hero + "_BACKresults_I.dat");
                 System.IO.StreamWriter II = new System.IO.StreamWriter(hero + "_BACKresults_II.dat");
                 System.IO.StreamWriter III = new System.IO.StreamWriter(hero + "_BACKresults_III.dat");

                 // To calculate statistics
                 List<result> resI = new List<result>();
                 List<result> resII = new List<result>();
                 List<result> resIII = new List<result>();
                 ...
                 foreach (String c in Terminals)
                 {
                     ...
                     for (int i = 0; i < 10; i++)
                     {
                         ...
                         result res = new result(randomComboList, fitness, creativity, normCreativity, surprise, normSurprise, efficiency, normEfficiency, highSurp, minSurp, highEff, minEff);
                         res.writeIntoFile(I);
